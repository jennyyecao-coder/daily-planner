...
### 3. ☁️ Firebase cloud sync (recommended for multi-device)
...
> ⚠️ Note: Firebase sign-in does not work on the GitHub Pages URL due to browser security restrictions (COOP headers). Use the Firebase Hosting URL for sync features.
...
| ✏️ Firestore writes | 20,000 / day |
| 🗄️ Firestore storage | 1 GB |
